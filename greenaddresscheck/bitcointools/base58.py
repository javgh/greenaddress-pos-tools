...
if __name__ == '__main__':
    # http://blockexplorer.com/tx/f4322b6195864a2f09d65f0003a1b88cd602ab22d5c36b95ca3048e6f18b3cbc

    x = 'cd6ad14adb279388258f6c61e288d1c9e87ca29b'.decode('hex_codec')
    print hash_160_to_bc_address(x)

    x2 = '044d9c7dea9f6086422d2e86a4592ccbe51bad861c2ce01dcdeb4560cce6ecedf9b91514bd89cc1f96dfc401d75b2eb42cd6b5d36c7a30a602169a9dafc6ba789d'.decode('hex_codec')
    print public_key_to_bc_address(x2)
